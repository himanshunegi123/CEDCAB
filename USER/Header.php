     ...
     <nav class="navbar navbar-expand-sm bg-dark">
         ...
         <div class="collapse navbar-collapse" id="navbarNavDropdown">
             <ul class="navbar-nav">
                 ...
                 <li class="nav-item">
                     <a class="nav-link" href="../USER/UserNewRide.php">Book A Ride</a>
                 </li>
                 <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                         ...
                         <a class="dropdown-item" href="Ride.php">All Rides</a>
                     </div>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link" id="logout" href="Logout.php" aria-expanded="false">
                         Log out
                     </a>
                 </li>
             </ul>
